...
SECRET_KEY = 'django-insecure-%9n36im8o_dv-elkuqa3w*0)gy*v=lqaj(#+g0zhbgi24ai)m+'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the MTec⚡✨",

    # Copyright on the footer
    "copyright": "MTec Collection⚡✨",
